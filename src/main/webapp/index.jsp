    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Jenkins WebApplication</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="dropdown-menu">
                <li><a href="http://18.222.31.172:8080/job/Linux/build?token=linux">Linux</a></li>
                <li><a href="http://18.222.31.172:8080/job/project-test/build?token=sreekanthpro">sreekanth</a></li>
                <li><a href="http://18.222.31.172:8080/job/test-maven/build?token=test">test-maven</a></li>
